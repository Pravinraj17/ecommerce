     ...
     <div class="collapse navbar-collapse" id="mynavbar">
     	<ul class="navbar-nav">
          ...
          <a href="all_products.php" class="nav-link fw-semibold">products</a>
            ...
            <li class="nav-item mx-3">
          <a href="./user_area/user_registration1.php" class="nav-link fw-semibold">Register</a>
          ...
          <a href="javascript:void(0)" class="nav-link fw-semibold"><i class="bi bi-cart-fill"></i> <sup><?php cart_item_display(); ?></sup> </a>
        </li>
          </li>
            <li class="nav-item mx-3">
